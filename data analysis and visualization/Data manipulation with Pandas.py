...
min_lipid = food_info['Lipid_Tot_(g)'].min()
normalized_protein = (food_info['Protein_(g)'] - min_protein)/(min_protein - max_protein)
normalized_fat = (food_info['Lipid_Tot_(g)'] - min_lipid)/(min_lipid - max_lipid)
